...
public class ARPlacementManager : MonoBehaviour
{
    ...
    public GameObject battleAreaObj;
    ...
    void Update()
    {
        ...
        if(_arRaycastManager.Raycast(ray,raycast_Hits, TrackableType.PlaneWithinPolygon))
        {
            Pose hitPose = raycast_Hits[0].pose;
            Vector3 positionToBePlaced = hitPose.position;
            battleAreaObj.transform.position = positionToBePlaced;
        }
    }
}
